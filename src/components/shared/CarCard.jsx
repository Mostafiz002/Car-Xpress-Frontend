  ...
  return (
    <div className="bg-[#0a0a0a] text-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition flex flex-col h-full w-full border border-white/10 hover:-translate-y-1 hover:scale-101 duration-300">
      ...
      <div className="p-4 flex flex-col justify-between flex-1">
        <div>
          <div className="flex flex-col items-start justify-between mt-0">
            <img
              src={brandLogos[car.brand]}
              alt={car.brand}
              className="w-10 h-10 p-2 border rounded-full border-white/10 object-contain"
            />
        ...
        <div>
          ...
          <Link
            ...
            className="btn mt-4 w-full py-1.5 px-3 bg-[#ededed] text-sm text-[#111] rounded-lg font-medium cursor-pointer transition hover:bg-gray-300"
          >
            Details
          </Link>
        </div>
