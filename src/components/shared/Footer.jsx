    ...
    <footer className="bg-[#000000] border-t border-white/5 text-[#666666]">
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-[#666666]">
            <p className="flex items-center gap-2">
              <FaMapMarkerAlt className="text-[#666666]" /> Dhaka, Bangladesh
            </p>
            <p className="flex items-center gap-2">
              <FaPhoneAlt className="text-[#666666]" /> +880 1752-080666
            </p>
            <p className="flex items-center gap-2">
              <FaEnvelope className="text-[#666666]" /> mo.mahin4@gmail.com
            </p>
          </div>
      ...
      <div className="border-t border-white/5 py-4 text-center text-sm text-[#666666]">
        <p>
          ...
          <span className="font-semibold text-[#ededed]">CarXpress</span>. All
          rights reserved.
        </p>
      </div>
    </footer>
